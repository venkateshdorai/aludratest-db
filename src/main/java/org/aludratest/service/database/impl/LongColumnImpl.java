...
public class LongColumnImpl extends TableColumnImpl<Long> implements LongColumn {

    public LongColumnImpl(String columnName) {
        super(columnName);
    }

    @Override
    public Long getValueFromRowSet(RowSet rs) throws SQLException {
